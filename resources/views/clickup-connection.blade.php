            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="text-center">
                        <h3 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">{{ __('Connect to Clickup') }}</h3>
                    </div>
                    ...
                    @else
                        <div class="text-center">
                            <a href="{{ route('clickup.authorize') }}" class="btn btn-primary inline-block px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-700 dark:hover:bg-blue-600 dark:focus:ring-blue-400">
                                {{ __('Connect Clickup') }}
                            </a>
                        </div>
                    @endif
